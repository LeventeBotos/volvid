export const Header = () => {
  return (
    <nav className="fixed left-0 right-0 top-0 z-10 flex h-20 flex-row items-center justify-between bg-[#1d1d1d] bg-opacity-70 px-4 py-2 backdrop-blur-lg backdrop-filter md:h-28 md:py-4 ">
      <img
