export const About = () => {
  return (
    <section className="flex flex-col justify-evenly gap-4 text-center md:px-10">
      <p className=" text-center text-2xl font-bold">Rólunk</p>
      <div className="h-96 overflow-y-scroll px-2 text-xl md:px-1  lg:h-60 xl:px-20">
        ...
        profizmussal álljunk rendelkezésre ügyfeleinknek. Jelenleg két állandó
